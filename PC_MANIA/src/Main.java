...
public class Main {
    public static void main(String[] args) {
        ...
        hardB1[0] = new hardwareBasico("Pentium Core i3", 2000);
        ...
        Computador computador1 = new Computador("Positivo", 3300f, sys1, hardB1);
        computador1.addMemoriaUSB(new memoriaUSB("Pen-Drive", 16));
        Computador computador2 = new Computador("Acer", 8800f, sys2, hardB2);
        computador2.addMemoriaUSB(new memoriaUSB("Pen-Drive", 32));
        Computador computador3 = new Computador("Vaio", 4400, sys3, hardB3);
